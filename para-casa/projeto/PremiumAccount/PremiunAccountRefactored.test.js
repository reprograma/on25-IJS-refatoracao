import PremiumAccountRefactored from "./PremiunAccountRefactored";

let premiumAccount, frompremiumAccount, topremiumAccount;

beforeEach(() => {
    premiumAccount = new PremiumAccountRefactored();
    frompremiumAccount = new PremiumAccountRefactored();
    topremiumAccount = new PremiumAccountRefactored();
})

describe("Teste da classe PremiumAccountRefactored", () => {
  test("verificar se instancia de PremiumAccountRefactored é feita corretamente", () => {
    expect(premiumAccount instanceof PremiumAccountRefactored).toBe(true);
